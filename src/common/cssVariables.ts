...
export const cssVariableFallbacks = {
  ...
  get "composer-height-min"() {
    return {
      value: `calc(2 * ${cssVar("line-height-body")})`,
    };
  },
  get "composer-border"() {
...
//   "sidebar-z-index": { value: ZINDEX.sidebar.toString() },
  ...
  "annotation-pin-color": "color-brand-primary",
  "annotation-pin-outline-color": "color-base",
//   "annotation-pin-z-index": { value: ZINDEX.annotation.toString() },
  "annotation-pin-rotate": { value: "0deg" },
  ...
  // Applies to `<FloatingThread />`, which is rendered
  // by FloatingThreads and SelectionComments.
  "floating-threads-max-height": { value: "90vh" },
  ...
  "page-presence-avatar-size": "space-l",
...
//   "notification-list-height": { value: NOTIFICATION_WRAPPER.height },
//   "notification-list-width": { value: NOTIFICATION_WRAPPER.width },

  get "inbox-border"() {
    return { value: `1px solid ${cssVar("color-base-x-strong")}` };
  },
  "inbox-border-radius": "border-radius-medium",
  "inbox-height": { value: "600px" },
  "inbox-width": { value: "400px" },
...
export const _fallbackValueTest: Array<CSSVariable | { value: string }> =
  Object.values(cssVariableFallbacks);
